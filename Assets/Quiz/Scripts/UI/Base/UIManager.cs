...
namespace Quiz
{
    ...
    public class UIManager : MonoBehaviour
    {
        ...
        // Logs the m_History stack for troubleshooting.
        private void DebugHistory()
        {
            ...
            string debugMessage = "History: ";
            foreach (UIScreen screen in m_History)
            {
                debugMessage += screen.GetType().Name + " -> ";
            }
            debugMessage = debugMessage.TrimEnd(new char[] { ' ', '-', '>' }); // Remove trailing arrow and spaces
